 ...
 * (issuer, publicOrigin) or "auto" (TLS cert/key paths) are intentionally absent here and
 * resolved later. `seedOnStart` is intentionally absent (its default is "true if DB empty",
 * decided by #2).
 */
